...
- Szybkość przez: blueprint/clone (kasuje setup) · HTML-section build + biblioteka sekcji (build z placeholderów) · build równoległy · zdjęcia w tle · QA headless zamiast oczu Claude.
