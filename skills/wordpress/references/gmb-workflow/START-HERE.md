...
5. **Build** — Codex wypełnia sekcje z `section-library.md` (równolegle per strona); stack wg `STACK-DECISION-GUIDE.md` (domyślnie NATYWNY Elementor, inny builder/plugin tylko przy sygnale z briefu).
6. **SEO** — Yoast (Faza 4C).
